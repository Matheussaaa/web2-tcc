...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown ps-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{route('clientes.index')}}" class="dropdown-item">Pacientes</a></li>
                            <li><a href="{{route('higienes.index')}}" class="dropdown-item">Higiene Parenquima</a></li>
                            <li><a href="{{route('parametros.index')}}" class="dropdown-item">Parametros Atingidos</a></li>
                            <li><a href="{{route('status.index')}}" class="dropdown-item">Status Clinico</a></li>
                            <li><a href="{{route('vents.index')}}" class="dropdown-item">Ventilação Mecânica</a></li>
                        </ul>
                    </li>
    ...
    <div class="container py-4">
        <div class="row">
            ...
            @if(isset($rota) && UserPermission::isAuthorized('clientes.create'))
